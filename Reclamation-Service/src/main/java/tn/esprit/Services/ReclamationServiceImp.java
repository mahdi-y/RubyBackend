...
import tn.esprit.Clients.UserServiceClient;
import DTO.Entities.User.User;
import DTO.Entities.Livraison.*;
import tn.esprit.Clients.LivraisonServiceClient;
@Service
public class ReclamationServiceImp implements IReclamationService{
	...
	@Autowired
	LivraisonServiceClient LivraisonRepo;
	...
	public Reclamation addReclamation(Reclamation rec,Long idUser,Long idLivraison) {
		...
		Livraison livraison = LivraisonRepo.retrieveLivraison(idLivraison);
		rec.setUser(u);
	...
	@Override
	public Livraison omk(Long id) {
		// TODO Auto-generated method stub

		return LivraisonRepo.retrieveLivraison(id);
	}
	...
	public void assignReclamationToLivraison(Long idLivraison,Long idReclamation) {
		Livraison liv = LivraisonRepo.retrieveLivraison(idLivraison);
		Reclamation rec = ReclamationRepo.findById(idReclamation).orElse(null);
