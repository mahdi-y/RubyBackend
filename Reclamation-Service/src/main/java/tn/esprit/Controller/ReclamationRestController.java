...
public class ReclamationRestController {
	...
	List<Reclamation> listReclamations = (List<Reclamation>) ReclamationService.retrieveAllReclamations();
	...
	@GetMapping("/retrieve-liv/{id}")
	@ResponseBody
	public Livraison retrieveReclamation1(@PathVariable("id") Long idReclamation) {
		return ReclamationService.omk(idReclamation);
	}
